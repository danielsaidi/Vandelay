...
open class FilesRoutes {
    ...
    open func alphaGetMetadata(_ path: String, includeMediaInfo: Bool = false, includeDeleted: Bool = false, includeHasExplicitSharedMembers: Bool = false, includePropertyTemplates: Array<String>? = nil) -> RpcRequest<Files.MetadataSerializer, Files.AlphaGetMetadataErrorSerializer> {
    ...
    open func alphaUpload(_ path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, propertyGroups: Array<Properties.PropertyGroup>? = nil, input: Data) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorWithPropertiesSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadErrorWithProperties` object on failure.
    open func alphaUpload(_ path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, propertyGroups: Array<Properties.PropertyGroup>? = nil, input: URL) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorWithPropertiesSerializer> {
        let route = Files.alphaUpload
        let serverArgs = Files.CommitInfoWithProperties(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute, propertyGroups: propertyGroups)
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadErrorWithProperties` object on failure.
    open func alphaUpload(_ path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, propertyGroups: Array<Properties.PropertyGroup>? = nil, input: InputStream) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorWithPropertiesSerializer> {
        let route = Files.alphaUpload
        let serverArgs = Files.CommitInfoWithProperties(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute, propertyGroups: propertyGroups)
    ...
    open func copy(_ fromPath: String, toPath: String) -> RpcRequest<Files.MetadataSerializer, Files.RelocationErrorSerializer> {
    ...
    open func copyReferenceGet(_ path: String) -> RpcRequest<Files.GetCopyReferenceResultSerializer, Files.GetCopyReferenceErrorSerializer> {
    ...
    open func copyReferenceSave(_ copyReference: String, path: String) -> RpcRequest<Files.SaveCopyReferenceResultSerializer, Files.SaveCopyReferenceErrorSerializer> {
    ...
    open func createFolder(_ path: String) -> RpcRequest<Files.FolderMetadataSerializer, Files.CreateFolderErrorSerializer> {
    ...
    open func delete(_ path: String) -> RpcRequest<Files.MetadataSerializer, Files.DeleteErrorSerializer> {
    ...
    open func download(_ path: String, rev: String? = nil, overwrite: Bool = false, destination: @escaping (URL, HTTPURLResponse) -> URL) -> DownloadRequestFile<Files.FileMetadataSerializer, Files.DownloadErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.DownloadError` object on failure.
    open func download(_ path: String, rev: String? = nil) -> DownloadRequestMemory<Files.FileMetadataSerializer, Files.DownloadErrorSerializer> {
        let route = Files.download
        let serverArgs = Files.DownloadArg(path: path, rev: rev)
        return client.request(route, serverArgs: serverArgs)
    }
    ...
    open func getMetadata(_ path: String, includeMediaInfo: Bool = false, includeDeleted: Bool = false, includeHasExplicitSharedMembers: Bool = false) -> RpcRequest<Files.MetadataSerializer, Files.GetMetadataErrorSerializer> {
    ...
    open func getPreview(_ path: String, rev: String? = nil, overwrite: Bool = false, destination: @escaping (URL, HTTPURLResponse) -> URL) -> DownloadRequestFile<Files.FileMetadataSerializer, Files.PreviewErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.PreviewError` object on failure.
    open func getPreview(_ path: String, rev: String? = nil) -> DownloadRequestMemory<Files.FileMetadataSerializer, Files.PreviewErrorSerializer> {
        let route = Files.getPreview
        let serverArgs = Files.PreviewArg(path: path, rev: rev)
        return client.request(route, serverArgs: serverArgs)
    }
    ...
    open func getTemporaryLink(_ path: String) -> RpcRequest<Files.GetTemporaryLinkResultSerializer, Files.GetTemporaryLinkErrorSerializer> {
    ...
    open func getThumbnail(_ path: String, format: Files.ThumbnailFormat = .jpeg, size: Files.ThumbnailSize = .w64h64, overwrite: Bool = false, destination: @escaping (URL, HTTPURLResponse) -> URL) -> DownloadRequestFile<Files.FileMetadataSerializer, Files.ThumbnailErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.ThumbnailError` object on failure.
    open func getThumbnail(_ path: String, format: Files.ThumbnailFormat = .jpeg, size: Files.ThumbnailSize = .w64h64) -> DownloadRequestMemory<Files.FileMetadataSerializer, Files.ThumbnailErrorSerializer> {
        let route = Files.getThumbnail
        let serverArgs = Files.ThumbnailArg(path: path, format: format, size: size)
        return client.request(route, serverArgs: serverArgs)
    }
    ...
    open func listFolder(_ path: String, recursive: Bool = false, includeMediaInfo: Bool = false, includeDeleted: Bool = false, includeHasExplicitSharedMembers: Bool = false) -> RpcRequest<Files.ListFolderResultSerializer, Files.ListFolderErrorSerializer> {
    ...
    open func listFolderContinue(_ cursor: String) -> RpcRequest<Files.ListFolderResultSerializer, Files.ListFolderContinueErrorSerializer> {
    ...
    open func listFolderGetLatestCursor(_ path: String, recursive: Bool = false, includeMediaInfo: Bool = false, includeDeleted: Bool = false, includeHasExplicitSharedMembers: Bool = false) -> RpcRequest<Files.ListFolderGetLatestCursorResultSerializer, Files.ListFolderErrorSerializer> {
    ...
    open func listFolderLongpoll(_ cursor: String, timeout: UInt64 = 30) -> RpcRequest<Files.ListFolderLongpollResultSerializer, Files.ListFolderLongpollErrorSerializer> {
    ...
    open func listRevisions(_ path: String, limit: UInt64 = 10) -> RpcRequest<Files.ListRevisionsResultSerializer, Files.ListRevisionsErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.Metadata` object on success or a
    /// `Files.RelocationError` object on failure.
    open func move(_ fromPath: String, toPath: String) -> RpcRequest<Files.MetadataSerializer, Files.RelocationErrorSerializer> {
    ...
    /// `Files.DeleteError` object on failure.
    open func permanentlyDelete(_ path: String) -> RpcRequest<VoidSerializer, Files.DeleteErrorSerializer> {
    ...
    open func propertiesAdd(_ path: String, propertyGroups: Array<Properties.PropertyGroup>) -> RpcRequest<VoidSerializer, Files.AddPropertiesErrorSerializer> {
    ...
    open func propertiesOverwrite(_ path: String, propertyGroups: Array<Properties.PropertyGroup>) -> RpcRequest<VoidSerializer, Files.InvalidPropertyGroupErrorSerializer> {
    ...
    open func propertiesRemove(_ path: String, propertyTemplateIds: Array<String>) -> RpcRequest<VoidSerializer, Files.RemovePropertiesErrorSerializer> {
    ...
    open func propertiesTemplateGet(_ templateId: String) -> RpcRequest<Properties.GetPropertyTemplateResultSerializer, Properties.PropertyTemplateErrorSerializer> {
    ...
    open func propertiesUpdate(_ path: String, updatePropertyGroups: Array<Files.PropertyGroupUpdate>) -> RpcRequest<VoidSerializer, Files.UpdatePropertiesErrorSerializer> {
    ...
    open func restore(_ path: String, rev: String) -> RpcRequest<Files.FileMetadataSerializer, Files.RestoreErrorSerializer> {
    ...
    open func saveUrl(_ path: String, url: String) -> RpcRequest<Files.SaveUrlResultSerializer, Files.SaveUrlErrorSerializer> {
    ...
    open func saveUrlCheckJobStatus(_ asyncJobId: String) -> RpcRequest<Files.SaveUrlJobStatusSerializer, Async.PollErrorSerializer> {
    ...
    open func search(_ path: String, query: String, start: UInt64 = 0, maxResults: UInt64 = 100, mode: Files.SearchMode = .filename) -> RpcRequest<Files.SearchResultSerializer, Files.SearchErrorSerializer> {
    ...
    open func upload(_ path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, input: Data) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadError` object on failure.
    open func upload(_ path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, input: URL) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
        let route = Files.upload
        let serverArgs = Files.CommitInfo(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute)
        return client.request(route, serverArgs: serverArgs, input: .file(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadError` object on failure.
    open func upload(_ path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, input: InputStream) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
        let route = Files.upload
        let serverArgs = Files.CommitInfo(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute)
        return client.request(route, serverArgs: serverArgs, input: .stream(input))
    }
    ...
    open func uploadSessionAppend(_ sessionId: String, offset: UInt64, input: Data) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
    ...
    /// `Files.UploadSessionLookupError` object on failure.
    @available(*, unavailable, message:"upload_session/append is deprecated. Use upload_session/append_v2.")
    open func uploadSessionAppend(_ sessionId: String, offset: UInt64, input: URL) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppend
        let serverArgs = Files.UploadSessionCursor(sessionId: sessionId, offset: offset)
        return client.request(route, serverArgs: serverArgs, input: .file(input))
    }
    ...
    /// `Files.UploadSessionLookupError` object on failure.
    @available(*, unavailable, message:"upload_session/append is deprecated. Use upload_session/append_v2.")
    open func uploadSessionAppend(_ sessionId: String, offset: UInt64, input: InputStream) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppend
        let serverArgs = Files.UploadSessionCursor(sessionId: sessionId, offset: offset)
        return client.request(route, serverArgs: serverArgs, input: .stream(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionLookupError` object on failure.
    open func uploadSessionAppendV2(_ cursor: Files.UploadSessionCursor, close: Bool = false, input: Data) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionLookupError` object on failure.
    open func uploadSessionAppendV2(_ cursor: Files.UploadSessionCursor, close: Bool = false, input: URL) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppendV2
        let serverArgs = Files.UploadSessionAppendArg(cursor: cursor, close: close)
        return client.request(route, serverArgs: serverArgs, input: .file(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionLookupError` object on failure.
    open func uploadSessionAppendV2(_ cursor: Files.UploadSessionCursor, close: Bool = false, input: InputStream) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppendV2
        let serverArgs = Files.UploadSessionAppendArg(cursor: cursor, close: close)
        return client.request(route, serverArgs: serverArgs, input: .stream(input))
    }
    ...
    open func uploadSessionFinish(_ cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, input: Data) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadSessionFinishError` object on failure.
    open func uploadSessionFinish(_ cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, input: URL) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
        let route = Files.uploadSessionFinish
        let serverArgs = Files.UploadSessionFinishArg(cursor: cursor, commit: commit)
        return client.request(route, serverArgs: serverArgs, input: .file(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadSessionFinishError` object on failure.
    open func uploadSessionFinish(_ cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, input: InputStream) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
        let route = Files.uploadSessionFinish
        let serverArgs = Files.UploadSessionFinishArg(cursor: cursor, commit: commit)
        return client.request(route, serverArgs: serverArgs, input: .stream(input))
    }
    ...
    open func uploadSessionFinishBatch(_ entries: Array<Files.UploadSessionFinishArg>) -> RpcRequest<Async.LaunchEmptyResultSerializer, VoidSerializer> {
    ...
    open func uploadSessionFinishBatchCheck(_ asyncJobId: String) -> RpcRequest<Files.UploadSessionFinishBatchJobStatusSerializer, Async.PollErrorSerializer> {
